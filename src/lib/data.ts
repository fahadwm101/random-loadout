...
export const GAME_DATA: GameDatabase = {
  Light: {
    specializations: [
      { id: 'l_s_1', name: 'Cloaking Device', type: 'specialization' },
      { id: 'l_s_2', name: 'Evasive Dash', type: 'specialization' },
      { id: 'l_s_3', name: 'Grappling Hook', type: 'specialization' },
    ],
    weapons: [
      { id: 'l_w_1', name: '93R', type: 'weapon' },
      { id: 'l_w_2', name: 'ARN-220', type: 'weapon' },
      { id: 'l_w_3', name: 'Dagger', type: 'weapon' },
      { id: 'l_w_4', name: 'LH1', type: 'weapon' },
      { id: 'l_w_5', name: 'M11', type: 'weapon' },
      { id: 'l_w_6', name: 'M26 Matter', type: 'weapon' },
      { id: 'l_w_7', name: 'Recurve Bow', type: 'weapon' },
      { id: 'l_w_8', name: 'SH1900', type: 'weapon' },
      { id: 'l_w_9', name: 'SR-84', type: 'weapon' },
      { id: 'l_w_10', name: 'Sword', type: 'weapon' },
      { id: 'l_w_11', name: 'V9S', type: 'weapon' },
      { id: 'l_w_12', name: 'XP-54', type: 'weapon' },
      { id: 'l_w_13', name: 'Throwing Knives', type: 'weapon' },
    ],
    gadgets: [
      { id: 'l_g_1', name: 'Breach Charge', type: 'gadget' },
      { id: 'l_g_2', name: 'Flashbang', type: 'gadget' },
      { id: 'l_g_3', name: 'Frag Grenade', type: 'gadget' },
      { id: 'l_g_4', name: 'Gas Grenade', type: 'gadget' },
      { id: 'l_g_5', name: 'Gateway', type: 'gadget' },
      { id: 'l_g_6', name: 'Glitch Grenade', type: 'gadget' },
      { id: 'l_g_7', name: 'Goo Grenade', type: 'gadget' },
      { id: 'l_g_8', name: 'Gravity Vortex', type: 'gadget' },
      { id: 'l_g_9', name: 'H+ Infuser', type: 'gadget' },
      { id: 'l_g_10', name: 'Nullifier', type: 'gadget' },
      { id: 'l_g_11', name: 'Pyro Grenade', type: 'gadget' },
      { id: 'l_g_12', name: 'Smoke Grenade', type: 'gadget' },
      { id: 'l_g_13', name: 'Sonar Grenade', type: 'gadget' },
      { id: 'l_g_14', name: 'Thermal Bore', type: 'gadget' },
      { id: 'l_g_15', name: 'Tracking Dart', type: 'gadget' },
      { id: 'l_g_16', name: 'Vanishing Bomb', type: 'gadget' },
    ]
  },
  Medium: {
    specializations: [
    ...
    weapons: [
      ...
      { id: 'm_w_3', name: 'Cerberus 12GA', type: 'weapon' },
      { id: 'm_w_4', name: 'CL-40', type: 'weapon' },
      { id: 'm_w_5', name: 'Dual Blades', type: 'weapon' },
  ...
  Heavy: {
    specializations: [
      { id: 'h_s_1', name: "Charge 'N' Slam", type: 'specialization' },
      { id: 'h_s_2', name: 'Goo Gun', type: 'specialization' },
      { id: 'h_s_3', name: 'Mesh Shield', type: 'specialization' },
      { id: 'h_s_4', name: 'Winch Claw', type: 'specialization' },
    ],
    weapons: [
      { id: 'h_w_1', name: '.50 Akimbo', type: 'weapon' },
      { id: 'h_w_2', name: 'BFR Titan', type: 'weapon' },
      { id: 'h_w_3', name: 'Flamethrower', type: 'weapon' },
      { id: 'h_w_4', name: 'KS-23', type: 'weapon' },
      { id: 'h_w_5', name: 'Lewis Gun', type: 'weapon' },
      { id: 'h_w_6', name: 'M134 Minigun', type: 'weapon' },
      ...
      { id: 'h_w_11', name: 'Sledgehammer', type: 'weapon' },
      { id: 'h_w_12', name: 'Spear', type: 'weapon' },
    ],
    gadgets: [
      ...
      { id: 'h_g_6', name: 'Flashbang', type: 'gadget' },
      { id: 'h_g_7', name: 'Frag Grenade', type: 'gadget' },
      { id: 'h_g_8', name: 'Gas Grenade', type: 'gadget' },
      { id: 'h_g_9', name: 'Goo Grenade', type: 'gadget' },
      { id: 'h_g_10', name: 'Healing Emitter', type: 'gadget' },
      { id: 'h_g_11', name: 'Proximity Sensor', type: 'gadget' },
      { id: 'h_g_12', name: 'Pyro Grenade', type: 'gadget' },
      { id: 'h_g_13', name: 'Pyro Mine', type: 'gadget' },
      { id: 'h_g_14', name: 'RPG-7', type: 'gadget' },
      { id: 'h_g_15', name: 'Smoke Grenade', type: 'gadget' },
